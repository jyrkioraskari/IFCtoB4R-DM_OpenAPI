...
public class FileUtils {
	...
	/**
	 * Returns a list of all matching files at the source code base. The code base
	 * can be the application JAR file of the converter program.
	 * 
		...
		try {
			if (src != null) {
				...
				while (true) {
					...
					if (name.toLowerCase().startsWith(dir.toLowerCase())) {
